...
void HTMLFrameSetElement::parseMappedAttribute(Attribute* attr)
{
    if (attr->name() == rowsAttr) {
        ...
        document()->setWindowAttributeEventListener(eventNames().focusinEvent, NULL_METHOD_RESULT(document()->frame(), attr));
    else if (attr->name() == onfocusoutAttr)
        document()->setWindowAttributeEventListener(eventNames().focusoutEvent, NULL_METHOD_RESULT(document()->frame(), attr));
