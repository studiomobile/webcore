...
void HTMLInputElement::parseMappedAttribute(Attribute* attr)
{
    if (attr->name() == nameAttr) {
        ...
        setAttributeEventListener(eventNames().searchEvent, NULL_METHOD_RESULT(this, attr));
        ...
        setAttributeEventListener(eventNames().webkitspeechchangeEvent, NULL_METHOD_RESULT(this, attr));
#endif
    else
