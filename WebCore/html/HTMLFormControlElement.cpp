...
void HTMLTextFormControlElement::parseMappedAttribute(Attribute* attr)
{
    if (attr->name() == placeholderAttr)
        ...
        setAttributeEventListener(eventNames().selectEvent, NULL_METHOD_RESULT(this, attr));
    else if (attr->name() == onchangeAttr)
        setAttributeEventListener(eventNames().changeEvent, NULL_METHOD_RESULT(this, attr));
    else
