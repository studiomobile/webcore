...
static UInt16 getUInt16WithByteIndex(CFDataRef data, CFIndex index) {
    UInt16 value = 0;
    CFDataGetBytes(data, CFRangeMake(index, 2), (UInt8 *)&value);
    return CFSwapInt16BigToHost(value);
}

static UInt32 getUInt32WithByteIndex(CFDataRef data, CFIndex index) {
    UInt32 value = 0;
    CFDataGetBytes(data, CFRangeMake(index, 4), (UInt8 *)&value);
    return CFSwapInt32BigToHost(value);
}

static UInt16 getUInt16(CFDataRef data, CFIndex index) {
    UInt16 value = 0;
...
static inline bool unicharIsHighSurrogate(UniChar c) { return c >= kUnicodeHighSurrogateStart && c <= kUnicodeHighSurrogateEnd; }
static inline bool unicharIsLowSurrogate(UniChar c) {return c >= kUnicodeLowSurrogateStart && c <= kUnicodeLowSurrogateEnd; }
static inline UInt32 convertSurrogatePairToUTF32(UniChar high, UniChar low) { return (UInt32)((high - 0xD800) * 0x400 + (low - 0xDC00) + 0x10000); }
...
static CMap * CMapCreate(CFDataRef fontTable, UInt32 segmentOffset, int format) 
{
...
static void CMapRelease(CMap * cmap) 
{
...
static CMap * CMGetCMapForFont(CGFontRef cgFont) 
{
...
static size_t CMap4GetGlyphIndicesForUnichar(CMap * cmap, UniChar const * s, CGGlyph * result, size_t count) 
{
...
static size_t CMap12GetGlyphIndicesForUnichar(CMap * cmap, UniChar const * s, CGGlyph * result, size_t count) 
{
