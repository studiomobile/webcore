...
#if OS(DARWIN)
    FontPlatformData(CTFontRef, float size, bool syntheticBold = false, bool syntheticOblique = false, FontOrientation = Horizontal,
...
private:
    ...
    void loadFont(CTFontRef font, float, CTFontRef& outFont, CGFontRef& cgFont);
