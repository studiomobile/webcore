...
void Document::createStyleSelector()
{
    ...
    m_styleSelector = adoptPtr(new CSSStyleSelector(this, m_styleSheets.get(), m_mappedElementSheet.get(), pageUserSheet(), NULL, 
...
void Document::logExceptionToConsole(const String& errorMessage, int lineNumber, const String& sourceURL)
{
    MessageType messageType = LogMessageType;
    addMessage(JSMessageSource, messageType, ErrorMessageLevel, errorMessage, lineNumber, sourceURL);
}
